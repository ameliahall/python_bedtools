...
#chrom start stop names(comma delimited) scores(comma delimited) gene names(comma delimited if multiple)
#it outputs a matrix with a header
#the first column is a unique identifier: chr_start_stop_gene
...
def main():
    ...
    for line in masterPeakFile:
        ...
        identifier = masterLineList[0] + ':' + masterLineList[1] + '_' + masterLineList[2] + '_' + string.strip(masterLineList[5]) # 6th column should be the gene, here, needs newline stripped.
