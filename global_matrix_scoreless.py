...
def main():
    ...
    for colNum,sample in enumerate(mergePeakFiles):
        ...
        sampleDict[samp] = colNum #notable, colnum is just giving a value to the key; ***can we give it samp as the value?
    ...
    for line in masterPeakFile:
        ...
        #doing this for gene_name inclusion and distance
        ...
        for key,score in sampScore:
            ...
            row[index] = key #setting this to key instead of score to see if we can just report the sample there
